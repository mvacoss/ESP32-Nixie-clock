...
// Automatic Summer/Winter Time Configuration (Central Europe)
const char* TIME_ZONE = "CET-1CEST,M3.5.0,M10.5.0/3"; 

// Display Timings (Milliseconds)
unsigned long PRIMARY_HOLD_TIME = 20000; // Time to stay on the main chosen mode (default: 20s)
unsigned long SWEEP_HOLD_TIME   = 3500;  // Time to show each "peek" mode (default: 3.5s)
unsigned long STARTUP_ANIM_SPD  = 100;   // Speed of the "Slot Machine" startup (default: 100ms)
